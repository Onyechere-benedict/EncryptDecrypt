	...
	return (
		<SafeAreaView style={styles.container}>
			<ScrollView contentContainerStyle={styles.scrollContainer}>
				...
				<TextInput style={styles.input} placeholder="Enter text to encrypt" value={plaintext} onChangeText={setPlaintext} />

				<Text style={styles.label}>Secret Key:</Text>
				<TextInput style={styles.input} placeholder="Enter secret key" value={key} onChangeText={setKey} />
